...
// renderer.setClearColor(0x0055FF)
...
function animate(time) {
  ...
  step += options.speed;
  sphere.position.y = 10 * Math.abs(Math.sin(step)) + sphere.geometry.parameters.radius;
